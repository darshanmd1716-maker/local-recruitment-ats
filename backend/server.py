...
{{
    ...
    "experience": "Total years of experience as STRING (e.g., '5 years')",
...
Return ONLY valid JSON, no other text. If information is not found, use null."""
    ...
    if data.get('experience') is not None and not isinstance(data['experience'], str):
        data['experience'] = f"{data['experience']} years"
    return data
